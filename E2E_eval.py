...
def evaluate_E2E(cfg, model, loader):
...
def main():
    ...
    parser.add_argument("--yaml_path", type=str, default="./configs/Stage2_end_to_end_finetuning.yaml")
    parser.add_argument("--pretrained_path", type=str, default="./pretrained/E2E.pth")
    parser.add_argument("--dataset_root", type=str, default="Set Your Dataset Root")

    cfg = parser.parse_args()
    cfg = override_config_with_yaml(cfg, cfg.yaml_path)
    os.environ['CUDA_VISIBLE_DEVICES'] = cfg.gpu

    model = CanonCGT_E2E(cfg)
    ...
    # evaluate_E2E(cfg, model, Supervised_loader)
    ...
    Unsupervised_loader = DataLoader(Unsupervised_testset, batch_size=20, num_workers=cfg.dataset['num_workers'], shuffle=False, generator=g)
    evaluate_E2E(cfg, model, Unsupervised_loader)
