...
from engines.style_encoder.forward_train import train_one_epoch
from engines.style_encoder.forward_test import evaluation
...
def train_process(cfg, model, criterion, optimizer, lr_scheduler):
    ...
    for epoch in range(start_epoch, cfg.training['epochs']):
        ...
        save_losses_and_performances(cfg, Losses, Performances['acc'], LRs)
